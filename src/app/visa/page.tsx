...
export const metadata: Metadata = {
  title: 'Visa Information for Americans | Morocco Advisors',
  description: 'What US citizens need to know about visiting and staying in Morocco. Tourist entry, long-stay visas, and the path to residency explained simply.',
};
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-atlas-700">
              Good news: US citizens can enter Morocco without a visa and stay up to 90 days.
              Here&apos;s what you need to know if you&apos;re thinking about staying longer.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="card border-2 border-atlas-200">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <span className="text-sm text-atlas-600 font-medium">Employment-based</span>
                </div>
              </div>
              <p className="text-atlas-600 mb-4">
      ...
      <section className="section-padding bg-atlas-800">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-4 text-lg text-sand-200">
            The paperwork can feel overwhelming, but it doesn&apos;t have to be.
            We&apos;ve helped many American families through this process and we&apos;re happy to help you too.
          </p>
