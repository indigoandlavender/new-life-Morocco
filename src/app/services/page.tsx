...
export const metadata: Metadata = {
  title: 'Relocation Services | Morocco Advisors',
  description: 'We help American families navigate the transition smoothly. Document preparation, residency support, housing help, and someone in your corner every step of the way.',
};
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-xl text-sand-200">
              ...
              not sitting in government offices. We handle the complexity
              so you can focus on your family and your new beginning.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white border-b border-sand-200">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center mb-10">
            <h2 className="text-2xl font-bold text-atlas-900">What We Help You Achieve</h2>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center p-4">
              ...
              <h3 className="font-semibold text-atlas-900 text-sm mb-1">Banking Set Up</h3>
              <p className="text-atlas-600 text-xs">Open accounts and protect your money</p>
            </div>
            <div className="text-center p-4">
              ...
              <h3 className="font-semibold text-atlas-900 text-sm mb-1">Find Your Home</h3>
              <p className="text-atlas-600 text-xs">Rent or buy with confidence</p>
            </div>
            <div className="text-center p-4">
              <div className="w-12 h-12 bg-atlas-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <svg className="w-6 h-6 text-atlas-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <h3 className="font-semibold text-atlas-900 text-sm mb-1">Legal Residency</h3>
              <p className="text-atlas-600 text-xs">Stay as long as you want</p>
            </div>
            <div className="text-center p-4">
              ...
              <h3 className="font-semibold text-atlas-900 text-sm mb-1">Peace of Mind</h3>
              <p className="text-atlas-600 text-xs">Someone in your corner throughout</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="card border-2 border-terracotta-200 relative">
              ...
              <div className="w-14 h-14 bg-atlas-100 rounded-xl flex items-center justify-center mb-6 mt-2">
              ...
              <div className="pt-4 border-t border-sand-200">
                <p className="text-atlas-600 font-semibold">Free</p>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl border-2 border-terracotta-300 p-8 md:p-10 shadow-lg relative">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-atlas-600 mb-4">
                  Already here and need your FBI background check apostilled in Washington, DC?
      ...
      <section className="section-padding bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="bg-gradient-to-r from-atlas-800 to-atlas-900 rounded-2xl p-8 md:p-12 text-white">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                <span className="text-sand-400 font-semibold">Best Value</span>
      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-4xl px-6 lg:px-8">
          <div className="bg-sand-50 border-l-4 border-terracotta-500 rounded-r-2xl p-8">
            <h3 className="text-xl font-bold text-atlas-900 mb-4">Our Commitment to You</h3>
            <p className="text-atlas-700 text-lg">
              Most families try to navigate the paperwork alone and end up spending their first months
              in government offices instead of settling in. We believe your time is too valuable for that.
              We handle the complexity so you can focus on what matters—your family and your new life.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-atlas-900">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="text-3xl font-bold text-white sm:text-4xl">
            Your First Days Exploring, Not Waiting in Line
          </h2>
          <p className="mt-4 text-lg text-sand-200">
            We handle the paperwork. The government offices. The bank setup.
            You focus on your family, your work, and your new beginning.
          </p>
          <div className="mt-10">
            <Link
              href="/contact"
